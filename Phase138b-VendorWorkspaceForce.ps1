...
Write-Host "=== Phase138b: FORCE Vendor Workspace Overview ===" -ForegroundColor Cyan
...
# Ensure app/vendor directory exists
...
# Backup existing vendor/page.tsx if present
...
# Write fresh vendor workspace page
$pageContent = @'
...
Write-Host "[INFO] Wrote fresh app/vendor/page.tsx (Vendor Workspace overview)." -ForegroundColor Green

# Deploy using your existing cloud deploy phase if present
...
Write-Host "=== Phase138b-VendorWorkspaceForce complete ===" -ForegroundColor Cyan
