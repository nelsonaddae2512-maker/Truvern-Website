<# =======================================================================
 Phase147-MetadataRebuild-Final.ps1
 Purpose: Force rebuild to surface new OG + canonical tags in HTML
 ======================================================================= #>

$ErrorActionPreference = 'Stop'
[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12

Write-Host "=== Phase147: Metadata Rebuild & OG/Canonical Verification ===" -ForegroundColor Cyan
...
# Step 4: Run local Vercel prebuild for verification
...
Write-Host "`nPhase147 complete — rebuild and verification finished." -ForegroundColor Green
