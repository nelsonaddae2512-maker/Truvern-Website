...
export async function POST(req: NextRequest) {
  try {
    // ✅ Enforces org membership + session implicitly
    ...
    const dueAtStr = typeof body?.dueAt === "string" ? body.dueAt.trim() : "";
    ...
    const created = await prisma.evidenceRequest.create({
      data: {
        ...
        // Stable + auditable without Clerk dependency
        requestedBy: `org:${org.id}`,
