...
Write-Host "=== Phase133b: Write real vendor pages (no folder changes) ===" -ForegroundColor Cyan
...
Write-Host "[INFO] Writing vendors list page..." -ForegroundColor Cyan
...
Write-Host "[OK] vendors/page.tsx written." -ForegroundColor Green

Write-Host "[INFO] Writing vendor detail page..." -ForegroundColor Cyan
            ...
            {vendor.assessments.map((a) => (
              ...
              >
                <p className="font-medium">
                  Risk level: <span className="text-sky-300">{a.riskLevel}</span>
                </p>
...
Write-Host "[OK] vendors/[id]/page.tsx written." -ForegroundColor Green

Write-Host "[STEP] Deploying with Vercel cloud build..." -ForegroundColor Cyan
vercel --prod --yes

Write-Host "=== Phase133b complete ===" -ForegroundColor Cyan
