# Phase75-UIComponents-Fixed.ps1 — safe root version
...
# 2) Set component root safely at project root
$root = (Get-Location).Path
$cmpRoot = Join-Path $root "components"
...
# 6) Write preview page inside app/reports/board
Sec "Writing preview page"
...
export default function BoardPreview({ searchParams }: { searchParams: { org?: string } }) {
  ...
  return (
    <main className="container mx-auto max-w-5xl px-6 py-8">
      <div className="mb-6">
        <Title>Board Summary Preview</Title>
...
Write-Host "Next: run .\\Phase74-NodeDirect-PlainFix.ps1 then visit:" -ForegroundColor Yellow
Write-Host "https://truvern.com/reports/board/preview?org=demo-2128873b" -ForegroundColor Yellow
