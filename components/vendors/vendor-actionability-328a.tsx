...
export default function VendorActionability328A(props: Props) {
  ...
  // ✅ never allow undefined to reach `.filter`
    ...
    <section className="rounded-3xl border border-white/10 bg-white/5 p-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {/* ✅ Review latest submission (only if we have one) */}
          {latestSubmittedId ? (
            <Link
          ...
          {/* ✅ Open requests (OPEN / unsubmitted) */}
          {openCount > 0 ? (
            <Link
      ...
      <div className="mt-4 grid grid-cols-1 gap-3 md:grid-cols-3">
        ...
        <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
          ...
          <div className="mt-1 text-xs text-white/50">Critical findings marked “accepted”.</div>
        </div>
