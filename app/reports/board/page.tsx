      ...
      <section className="max-w-6xl mx-auto px-4 py-10 space-y-10">
        ...
        <section className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <TemplateCard
              name="Template 1 Â· Risk Heatmap"
            ...
            />
            <TemplateCard
              name="Template 2 Â· Executive Summary"
            ...
            />
            <TemplateCard
              name="Template 3 Â· Business Service View"
            ...
            />
            <TemplateCard
              name="Template 4 Â· Remediation Tracker"
            ...
            />
            <TemplateCard
              name="Template 5 Â· Year-over-Year Trend"
