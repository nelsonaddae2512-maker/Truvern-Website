# Phase22-Rev5-Lite-Final.ps1 — resilient, continues past harmless CLI warnings

$ErrorActionPreference = 'Continue'
$host.ui.RawUI.WindowTitle = "Truvern • StallBuster Lite Final"
...
try {
  ...
  Write-Host "`n✅ Phase22-Rev5-Lite-Final complete." -ForegroundColor Green
